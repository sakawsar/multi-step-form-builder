...
function msfb_text_step( $data ){
    ...
    // echo '</pre>';
?>
<div data-price="<?php echo isset($data['question_price']) && $data['question_price'] != "" ? $data['question_price'] : ""; ?>" class="msfb-text w-4/5 m-auto flex flex-col mt-4 gap-4 <?php echo $data['step'] != 1 ? 'hidden':''; ?>" data-question-type="<?php echo $data['question_type']; ?>" data-msfb-node="<?php echo $data['id']; ?>">
