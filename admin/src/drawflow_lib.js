          ...
          class i {
              ...
              start() {
                  this.container.classList.add("parent-drawflow"),
                      ...
                      this.container.addEventListener("mousedown", this.contextmenu.bind(this)),
                      this.container.addEventListener("touchend", this.dragEnd.bind(this)),
                      this.container.addEventListener("touchmove", this.position.bind(this)),
                      this.container.addEventListener("touchstart", this.click.bind(this)),
                      this.container.addEventListener("touchstart", this.contextmenu.bind(this)),
              ...
              addNode(e, t, n, i, s, o, l, c, d = !1) {
                  ...
                  for (g = 0; g < n; g++) {
                      const e = document.createElement("div");
                      e.classList.add("output"), e.classList.add("output_" + (g + 1)), (m["output_" + (g + 1)] = { connections: [] }), p.appendChild(e);
                  }
