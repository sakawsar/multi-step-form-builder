...
//     let row_cals = row.querySelectorAll('td')
//     if(row_cals.length > 0){
//         for (let j = 0; j < row_cals.length; j++) {
//             const col = row_cals[j];
//             if(col.innerHTML.indexOf('class="fa') > -1){
//                 icon_list.push(col.querySelector('i').classList.value)
//                 // col.querySelector('i').classlist
//             }
//         }
//     }
// }
