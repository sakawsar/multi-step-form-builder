        ...
        <div class="sk-row">
          <div class="sk-col-md-3 sk-col-lg-2">
            <div class="skfb-feilds-panel">
              ...
              <div class="skfb-card skfb-feild-draggable" draggable="true" ondragstart="drag(event)" data-node="telegram">
                <div class="sk-row sk-align-items-center">
                  <div class="sk-col-10">
                    <div class="skfb-prev-input">
          ...
          <div class="sk-col-md-9 sk-col-lg-10" id="msfb_drawflow" ondrop="drop(event)" ondragover="allowDrop(event)"></div> <!-- /.col- -->
        </div> <!-- /.row -->
      </div>
    </div>
  </div>
  ...
  <div class="skfb-right-options">
    ...
    <div class="skfb__field-opt__boxes">
      <div class="skfb__field-box __2">
        ...
        <input type="text" placeholder="Text color would be blue" id="formName" />
      </div>
      <div class="skfb__field-box __2">
        <label for="formName">Choose icon</label>
        <select class="sk-form-control sk-custom-select skfb__custom-select">
          <option value="">Chose an icon</option>
          <option value="">1</option>
          <option value="">2</option>
          <option value="">3</option>
          <option value="">4</option>
