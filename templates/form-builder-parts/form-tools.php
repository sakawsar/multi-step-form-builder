<div class="sk-col-md-3 sk-col-lg-2 msfb-question-type-holders">
    <div class="skfb-feilds-panel">
        ...
        <div class="skfb-card skfb-feild-draggable" id="msfb-select-form-field">
            <div class="sk-row sk-align-items-center">
                <div class="sk-col-9">
                    <div class="skfb-prev-input">
                        <ul class="skfb-prev-checkbox">
        ...
        <div class="skfb-card skfb-feild-draggable" id="msfb-text-form-field">
            <div class="sk-row sk-align-items-center">
                <div class="sk-col-9">
                    <div class="skfb-prev-input">
        ...
        <div class="skfb-card skfb-feild-draggable" id="msfb-textarea-form-field">
            <div class="sk-row sk-align-items-center">
                <div class="sk-col-9">
                <div class="skfb-prev-input">
                        <div class="skfb-prev-text">
        ...
        <div class="skfb-card skfb-feild-draggable" id="msfb-date-form-field">
            <div class="sk-row sk-align-items-center">
                <div class="sk-col-9">
                    <div class="skfb-prev-input">
                        <div class="skfb-prev-text">
        ...
        <div class="skfb-card skfb-feild-draggable" id="msfb-slider-form-field">
            <div class="sk-row sk-align-items-center">
                <div class="sk-col-9">
                    <div class="skfb-prev-input">
